...
"""
        ...
        tx_call = Transaction(self.pk, contract_addr, 0, 1, gas_limit=1000, max_fee_per_gas=1, data="increment")
...
"""
        ...
        tx_call = Transaction(self.pk, contract_addr, 0, 1, gas_limit=1000, max_fee_per_gas=1, data="anything")
        tx_call.sign(self.sk)
    ...
    def test_out_of_gas(self):
        ...
        tx_call = Transaction(self.pk, contract_addr, 0, 1, gas_limit=1000, max_fee_per_gas=1, data="loop")
        tx_call.sign(self.sk)
